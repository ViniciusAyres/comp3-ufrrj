...
%>
<head>
    <title>Pontuação Competição</title>
</head>
<html>
<body>
<div class="container">
    <div class="card mt-5">
        <div class="card-header">
            <h4 class="font-weight-light mt-4 ml-2">Selecione uma das Competições abaixo para ver as provas e poder saber as Pontuações dos Atletas.</h4>
        </div>
