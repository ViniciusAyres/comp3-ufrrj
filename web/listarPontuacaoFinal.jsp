...
<div class="container">
    <div class="card mt-5">
        <div class="card-header">
            <h4 class="font-weight-light mt-4 ml-2">Selecione uma das Competições abaixo para saber sua pontuação final.</h4>
        </div>
                ...
                <table class="table table-bordered">
                    ...
                    <%
                        ...
                        for(a=0;a<stArrayCompeticoes.length;a++)
                        {
                            ...
                            out.print("<th><a href=\"pontuacaoFinal.jsp\"><button class=\"btn btn-outline-info\" >Selecionar</button></a></th>");
                            out.print("</tr>");
                        }
                    %>
                    </tbody>
